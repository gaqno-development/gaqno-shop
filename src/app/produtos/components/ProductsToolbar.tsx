...
export function ProductsToolbar({ sortBy, onSortChange, onToggleFilters }: Props) {
  return (
    <div className="mb-10 flex items-center justify-between border-b border-[var(--glass-border)] pb-5">
      <button
      ...
      <label className="ml-auto flex items-center gap-4">
        ...
        <select
          ...
          className="appearance-none border-b border-[var(--glass-border)] bg-transparent pb-1 pr-4 font-mono text-[0.72rem] uppercase tracking-[0.22em] text-[var(--ink)] focus:outline-none"
          style={{
            backgroundImage:
